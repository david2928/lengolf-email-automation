...
class CustomerService {
   ...
   * DEPRECATED: Use database trigger instead (set_customer_code)
   * This method is kept for backwards compatibility but shouldn't be used
   * @returns {Promise<string>} - Next customer code
   */
  async generateCustomerCode() {
    // This method is deprecated - the trigger should handle code generation
    // Kept for backwards compatibility only
    log('WARN', 'generateCustomerCode() called but should use trigger instead');
    return null; // Return null to indicate code should be auto-generated by trigger
  }
  ...
  async createCustomer(customerData) {
    try {
      ...
      // Don't specify customer_code - let the database trigger auto-generate it
      // This uses the same proven approach as lengolf-forms and lengolf-booking-new
      const newCustomer = {
        // customer_code will be auto-generated by trigger_set_customer_code
        customer_name: name,
